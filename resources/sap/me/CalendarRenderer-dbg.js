...
sap.me.CalendarRenderer._renderMonth = function(oRm, oControl, sMonthDate, sDateNow){
    ...
    var sMonthTitle = oControl._MONTHS[currentDate.getMonth()] + " " + currentDate.getFullYear();
    ...
    if(bSingleRow){
    	...
    	if(iFirstYear != iLastYear){
    		sMonthTitle = iFirstDate + " " + oControl._MONTHS[iFirstMonth] + " " + iFirstYear + " - " + iLastDate + " " + oControl._MONTHS[iLastMonth] + " " + iLastYear;
    	}
    	else if(iFirstMonth != iLastMonth){
    		sMonthTitle = iFirstDate + " " + oControl._MONTHS[iFirstMonth] + " - " + iLastDate + " " + oControl._MONTHS[iLastMonth] + " " + iLastYear;
    	}
    	else {
    		sMonthTitle = iFirstDate + " - " + iLastDate + " " + oControl._MONTHS[iLastMonth] + " " + iLastYear;
    	}
    }
