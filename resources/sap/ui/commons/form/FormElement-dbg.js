...
// TODO deactivated until Element/Control has been clarified: sap.ui.core.EnabledPropagator.call(sap.ui.commons.form.FormElement.prototype);
		...
		if (typeof oLabel === "string") {
			if (!this._oLabel) {
				if (!jQuery.browser.mobile) {
					...
					this._oLabel = new sap.m.Label({text: oLabel}).setParent(this);
				}
