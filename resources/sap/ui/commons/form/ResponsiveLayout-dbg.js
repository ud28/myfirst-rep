...
sap.ui.core.Control.extend("sap.ui.commons.form.ResponsiveLayoutPanel", {
	...
	metadata : {
		aggregations: {
			"content"   : {type: "sap.ui.commons.layout.ResponsiveFlowLayout", multiple: false}
		},
		associations: {
			"container" : {type: "sap.ui.commons.form.FormContainer", multiple: false},
			"layout"    : {type: "sap.ui.commons.form.ResponsiveLayout", multiple: false},
		}
	},
	...
	renderer : function(oRm, oPanel) {
		...
		if (oContainer.getTitle()) {
			oLayout.getRenderer().renderTitle(oRm, oContainer.getTitle(), oContainer._oExpandButton, bExpandable, sap.ui.commons.TitleLevel.H4, oContainer.getId());
		}
...
(function() {
	...
	var _createPanel = function( oLayout, oContainer, oRFLayout ) {
		...
		var sContainerId = oContainer.getId();
		var oPanel = new sap.ui.commons.form.ResponsiveLayoutPanel(sContainerId+"--Panel", {
			...
			if (!oLayout._mainRFLayout) {
				...
				for ( var i = 0; i < iContentLenght; i++) {
					...
					if (oContentElement.getContainer) {
						...
						// it's a RFLayout
						oContainer = oContentElement.__myParentContainer;
					}
