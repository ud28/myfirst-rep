...
sap.ui.commons.Button.prototype.handleMouseDown=function(e,f){if(this.getEnabled()&&this.getRenderer().onactive){this.getRenderer().onactive(this)}if(f&&(jQuery.browser.webkit||(jQuery.browser.mozilla&&navigator.platform.indexOf("Mac")===0))){if(jQuery.browser.mobile&&jQuery.browser.webkit){this.focus()}jQuery.sap.delayedCall(0,this,function(){this.focus()})}};
