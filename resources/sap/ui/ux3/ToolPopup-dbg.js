 ...
 * <li>{@link #getInverted inverted} : boolean (default: true)</li></ul>
 * </li>
 * <li>Aggregations
 * <ul>
...
sap.ui.ux3.ToolPopup.prototype.init = function() {
	...
	this._proxyFixTooLargeContent = jQuery.proxy(fnFixTooLargeContent, this);
};
sap.ui.ux3.ToolPopup.prototype.exit = function() {
	...
	if (this._bBoundOnResize){
		jQuery(window).unbind("resize", this._proxyFixTooLargeContent);
	}
 ...
 */
var fnFixTooLargeContent = function(){
	var $this = this.$();
	...
	if (!this._bInitialFix || this._bInitialFix && iHeight > iWinHeight) {
		...
		$content.addClass("sapUiUx3TPLargeContent");

		$this.addClass("sapUiUx3TPLargeContent");
	}
	
	if (!this._bBoundOnResize) {
		jQuery(window).bind("resize", this._proxyFixTooLargeContent);
		this._bBoundOnResize = true;
	}
};
...
var fnPopupOpened = function(){
	...
	this._bInitialFix = true; // will be deleted in _proxyFixTooLargeContent
	this._proxyFixTooLargeContent();
};
 ...
 * enabled while it is OPENING or OPEN. Descendant controls that honor the enabled state of their  
 * ancestors will appear disabled after the ToolPopup is closed.
 * 
...
sap.ui.ux3.ToolPopup.prototype._ensurePopup = function() {
	if (!this.oPopup) {
		...
		this.oPopup._applyPosition = function(){
			...
			var sClassAttr = oThis.isInverted() ? "sapUiUx3TPArrow sapUiTPInverted sapUiUx3TPArrow" : "sapUiUx3TPArrow sapUiUx3TPArrow";
			$arrow.attr("class", sClassAttr + oThis.sArrowDir);
...
sap.ui.ux3.ToolPopup.prototype.isInverted = function() {
	var sParam = "sap.ui.ux3.ToolPopup:";
	sParam += "sapUiUx3ToolPopupInverted";

	sParam = sap.ui.core.theming.Parameters.get(sParam);
	var bThemeInverted = sParam === "true" ? true : false;

	return this.getInverted() && bThemeInverted;
};
