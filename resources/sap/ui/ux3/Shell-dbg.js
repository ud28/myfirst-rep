...
sap.ui.ux3.Shell.prototype._getSearchTool = function() {
	if (!this._oSearchPopup) {
		...
		var bInverted = this.getDesignType() !== sap.ui.ux3.ShellDesignType.Light;
...
sap.ui.ux3.Shell.prototype.setDesignType = function(sDesignType) {
	...
	var bInverted = sDesignType !== sap.ui.ux3.ShellDesignType.Light;
	...
	this.$()
		...
		.addClass("sapUiUx3ShellDesign" + this.getDesignType());
	return this;
};
